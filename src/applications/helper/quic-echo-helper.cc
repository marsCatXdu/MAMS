...
void 
QuicEchoClientHelper::SetIniRTT0 (Time rtt0)
{
  owd_0 = rtt0;
}

void 
QuicEchoClientHelper::SetIniRTT1 (Time rtt1)
{
  owd_1 = rtt1;
}

void 
QuicEchoClientHelper::SetBW0 (DataRate bw0)
{
  bw_0 = bw0;
}

void 
QuicEchoClientHelper::SetBW1 (DataRate bw1)
{
  bw_1 = bw1;
}

void 
QuicEchoClientHelper::SetER (double error_p)
{
  errorRate = error_p;
}

void 
QuicEchoClientHelper::SetScheAlgo (double Algo)
{
  m_pktScheAlgo = Algo; //1. quic-rr (quic with round-robin), 2, mpquic-rr, 3. mpquic-ofo (our proposed scheduler for solving ofo issue)
}

void 
QuicEchoClientHelper::WithMobility (bool mob)
{
  withMob = mob;
}
